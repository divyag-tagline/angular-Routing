...
import { AwardsRecognitions, ChooseTagline, Empowerbox, Empowerbox1, ExperienceDetailsLeft, ExperienceDetailsRight, FooterDetails, FooterHelp, FooterHrInquiry, FooterLastPortion, FormDetails, GlobalPresence, OurBlogs, OurClientele, RatingBox, ServiceCard1, ServiceCard2, ServiceCard3, TechnologyBackEnd } from '../common';
